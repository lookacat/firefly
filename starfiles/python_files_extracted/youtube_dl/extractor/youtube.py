            ...
            while count <= retries:
                try:
                    ...
                    more = self._download_json(
                        'http://youtube.com/%s' % mobj.group('more'), playlist_id,
    ...
    def _real_extract(self, url):
        ...
        if re.search(r'player-age-gate-content">', video_webpage) is not None:
            ...
            data = compat_urllib_parse_urlencode({
                'video_id': video_id,
                'eurl': 'http://youtube.googleapis.com/v/' + video_id,
...
class YoutubePlaylistIE(YoutubePlaylistBaseInfoExtractor):
    ...
    def _extract_mix(self, playlist_id):
        ...
        for n in itertools.count(1):
            url = 'http://youtube.com/watch?v=%s&list=%s' % (last_id, playlist_id)
...
class YoutubeFeedsInfoExtractor(YoutubeBaseInfoExtractor):
    ...
    def _entries(self, page):
        ...
        for page_num in itertools.count(1):
            ...
            more = self._download_json(
                'http://youtube.com/%s' % mobj.group('more'), self._PLAYLIST_TITLE,
